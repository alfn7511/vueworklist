...
#devWrap {
	...
	* html .modal-overlay {
	...
	.layer-type1 .layer-header .btn-close {
		position: absolute;
		right: 0;
		top: 0;
		width: 21px;
	...
	.layer-type1 .layer-header .btn-close span {
		position: absolute;
		left: 0;
		top: 0;
		width: 21px;
		height: 21px;
		background: #fff url(img/btn_close.gif) no-repeat 50% 50%;
	}
  ...
  ---------------------------------------------- */
	...
	.tbl-type1 thead th.header span {
		display: block;
		padding-right: 20px; /* background:url(img/bg.gif) no-repeat 100% 50%; */
		cursor: pointer;
	}
	.tbl-type1 thead th.header.headerSortDown span {
		background: url(img/asc.gif) no-repeat 100% 50%;
		background-size: 15px 15px;
	}
	.tbl-type1 thead th.header.headerSortUp span {
		background: url(img/desc.gif) no-repeat 100% 50%;
		background-size: 15px 15px;
	}
	.tbl-type1 tbody tr.even td {
		background: #f2f2f2;
	}
	.tbl-type1 tbody tr.line td {
		border-bottom: 1px solid #333;
	}
	.tbl-type1 tbody .link {
		cursor: pointer;
		color: -webkit-link;
		text-decoration: underline;
	}
	.modify_desc .tbl-type1 {
		margin: 0;
	}
	...
	.msg-box .setup-path span {
		padding: 7px 10px;
		background-color: #007100;
	}
	.msg-box .syntax-container {
		margin: 1em 0;
		padding: 0;
	}
	.msg-box .syntax-container.syntax-theme-base .toolbar a {
		font-size: 12px;
	}
